...
class RPR(robot_arm.Robot_arm):
    ...
    def __init__(self, m, n,
        ...
        self.ot_vect = np.array([[0], [0], [n]])

        # Le robot RPR est un robot avec 3 liasions
    ...
    def mgi_func(self, X):
        ...
        # Les équations sont résolues avec 2 épsilones qui sont égales à -1 ou 1 (il y aura donc 4 solutions maximum)
        Epsilonesin = [1, -1]
        Epsilone1 = [1, -1]
